...
# R을 이용한 퇴적물 입도조성 자료 시각화 하기(1) <!-- 첫 h1이 씨랩 글제목이 됩니다. 블럭 아닌 구간에서 샵(#) 하나 = h1 -->
...
<img src="images/02.rysgran_diagram.png" alt="그림 2. 퇴적물 조성비 삼각다이어그램" border="3px" width="1000px" height="1000px"  align="center">__그림 2. 퇴적물 조성비 삼각다이어그램__    
<br>

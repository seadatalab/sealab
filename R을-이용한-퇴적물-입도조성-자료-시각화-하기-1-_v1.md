...
![그림 1. JOISS에서 제공하는 예제파일 구조](images/01.rysgran_01_joiss_data.png)
![그림 1. JOISS에서 제공하는 예제파일 구조](images/01.rysgran_01_joiss_data.png)*그림 1. JOISS에서 제공하는 예제파일 구조*
<img src="images/01.rysgran_01_joiss_data.png" alt="외부 이미지" height="100px" />*그림 1. JOISS에서 제공하는 예제파일 구조*
<br> 

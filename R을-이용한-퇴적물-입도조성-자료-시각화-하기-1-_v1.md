...
이번 튜토리얼에서는 해양저질 표층 퇴적물의 입도조성 자료를 R에서 제공하는 “rysgran” package를 이용해 시각화하는 방법을 설명하고자 한다.   
...
![ __그림 1. JOISS에서 제공하는 예제파일 구조 __](G:\R\Rmarkdown\01.rysgran_sediment\01.fig\v1.0\rysgran_01_joiss data.png)
